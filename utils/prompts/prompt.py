...
BIAS_PROMPT = [
    {
        "role": "system",
        "content": "You are an AI language model. Your task is to generate a JSON-formatted output. Please follow the JSON structure guidelines:",
    },
    {
        "role": "system",
        "content": "1. Begin the output with a '{' (left curly brace) and end it with a '}' (right curly brace)."
    ...
    {
        "role": "system",
        "content": "You will be provided with a web-scraped media article."
...
def generate_response(prompt):
    response = openai.ChatCompletion.create(
        model="gpt-3.5-turbo-16k", messages=prompt, temperature=0.9
    )
