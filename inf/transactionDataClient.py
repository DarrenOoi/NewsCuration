  ...
  """
    ...
    def establishConnection(self):
        ...
        self.logMessage(messageStatus.SUCCESS,
                        f'Established connection to database {DB}')
        return cursor, cnx

    def closeConnection(self):
        self.logMessage(messageStatus.SUCCESS,
                        f'Closing Connection {self.cnx}')
  ...
  """
    ...
    def generateFromSqlFile(self, sqlFileName=str):
        try:
            ...
            self.logMessage(messageStatus.FAIL,
                            f'Unable to find file path: {sqlFileName}')
  ...
  '''
    ...
    """
        try:
            ...
            self.logMessage(messageStatus.FAIL,
                            f'error building sql statement with error {e}')
  ...
  '''
    ...
    def insert(self, table=type(table)):
        ...
        try:
            ...
            self.logMessage(
                messageStatus.FAIL, f'error parsing SQL statement {DDLMethod}: \n error {e}')
        ...
        self.logMessage(messageStatus.SUCCESS,
                        f"Successfully attempted query: {DDLMethod}")
    ...
    """
        ...
        try:
            ...
            self.logMessage(messageStatus.FAIL,
                            f'failed to commit query \n {query} \n reason: {e}')
        self.logMessage(messageStatus.SUCCESS,
                        f"Sucessfully transacted query: {query}")
        ...
        try:
            ...
            self.logMessage(
                messageStatus.FAIL, f'failed to properly insert record. Check table name exists and/or is correct.')
            return None
