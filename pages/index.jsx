            ...
            <div>
              <div>
                <text className='text-white font-bold text-xl'>
                  <text className='text-[#FFB039]'>JUST THE FACTS</text>{' '}
                  functions as a web application aimed at aiding users in
                  extracting unbiased information from political articles,
                  allowing them to access only factual content.{' '}
                  <text className='text-[#FFB039]'>START</text> by either
                  inputting an article URL or providing text input.
                </text>
              </div>
